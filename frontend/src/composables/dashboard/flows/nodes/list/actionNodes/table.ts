                ...
                expectedOutput: [
                    {
                        ...
                        key: 'success',
                        type: 'boolean',
                        description: 'Whether the record(s) were created successfully'
                    },
                    {
                        name: 'Record IDs',
                        key: 'recordIds',
                        type: 'array',
                        description: 'Array of IDs for all newly created records'
                    },
                    {
                        name: 'Record ID',
                        key: 'recordId',
                        type: 'string',
                        description: 'ID of the first created record (for backward compatibility)'
                    },
                    {
                        name: 'Created At',
                        key: 'created_at',
                        type: 'string',
                        description: 'Timestamp when the records were created'
                    },
                    {
                        name: 'Records',
                        key: 'records',
                        type: 'array',
                        description: 'Array of all created record data'
                    },
                    {
                        name: 'Record',
                        key: 'record',
                        type: 'object',
                        description: 'The first created record data (for backward compatibility)'
                    },
                    {
                        name: 'Total Records Created',
                    ...
                    },
                    {
                        ...
                        key: 'aiGeneratedData',
                        type: 'object',
                        description: 'The data generated by AI'
                    }
                ]
            },
            {
