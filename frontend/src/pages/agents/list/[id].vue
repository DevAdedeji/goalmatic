	...
	>
		...
		<section id="about" class="card md:mt-8 mt-4 gap-2">
			...
			<textarea
				...
				class="input-textarea w-full min-h-[150px] text-sm text-subText"
				placeholder="Enter agent description..."
			/>
			<!-- Display description text when not editing -->
			<div
				v-else
				class="text-sm text-subText prose max-w-none"
				v-html="descriptionModel || '<p>No description provided.</p>'"
			/>
		</section>
